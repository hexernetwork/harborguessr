...
//           // Update view counts - ensure all required fields are included
...
//           supabase
//             .from("trivia_questions")
//             .upsert(updates, { onConflict: "id,language" })
//             .then(({ error }) => {
...
//   console.log("saveLocationGameScore called with:", { userId, score, rounds, language });
...
//       console.error("Supabase authentication error or no active session:", authError?.message || "No session");
//       return null;
//     }
...
//     if (error) {
//       console.error("Error saving location game score:", {
...
//     console.log("Location game score saved successfully:", data);
//     return true;
//   } catch (error) {
//     console.error("Unexpected error in saveLocationGameScore:", {
//       message: error.message,
//       stack: error.stack
//     });
//     return null;
...
//   console.log("saveTriviaGameScore called with:", { userId, score, questionsAnswered, correctAnswers, language });
...
//     return true; // Return true instead of data
//   } catch (error) {
