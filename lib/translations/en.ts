...
const en = {
  ...
  home: {
    ...
    locationGameDescription: "Find Finnish harbors on nautical charts using progressive hints. Each wrong guess reveals a new hint!",
  ...
  about: {
    ...
    projectDescription: "Finnish Harbor Guesser is an educational game designed to help users learn about Finland's diverse harbors, marinas, and ports. From the bustling commercial ports of Helsinki and Turku to the remote guest harbors in the outer archipelago, Finland offers a rich maritime landscape to explore.",
    howItWorksTitle: "How It Works",
    howItWorksDescription: "The application offers two main game modes:",
    locationGameTitle: "Location Game",
    locationGameDescription: "Test your geographical knowledge by finding Finnish harbors on the map. You'll be given hints and need to pinpoint the location as accurately as possible. The closer your guess, the more points you'll earn!",
    triviaGameTitle: "Trivia Game",
    triviaGameDescription: "Challenge your knowledge about Finnish harbors with our trivia questions. Learn interesting facts about Finland's maritime history, geography, and culture while having fun!",
    dataSourcesTitle: "Data Sources",
    dataSourcesDescription: "The harbor data used in this application has been compiled from various sources, including official maritime charts, harbor guides, and local knowledge. While we strive for accuracy, the information should not be used for actual navigation purposes.",
    mapAttributionTitle: "Map Attribution",
    mapAttributionDescription: "Map data © OpenStreetMap contributors",
    mapAttributionLicense: "This application uses map tiles from OpenStreetMap, which is open data, licensed under the Open Data Commons Open Database License (ODbL)",
  },
  howToPlay: {
    title: "How to Play",
    locationGameTitle: "Location Game",
    locationGameDescription: "The Location Game tests your knowledge of Finnish harbors and their geographical locations. Here's how to play:",
    locationGameSteps: [
      { title: "Start the game", description: "You'll be presented with a harbor to find and some initial hints about its location." },
      { title: "Read the hints", description: "Use the provided hints to narrow down the possible location of the harbor." },
      { title: "Make your guess", description: "Click on the map where you think the harbor is located. You can adjust your selection before confirming." },
      { title: "Confirm your guess", description: "Once you're confident in your selection, click the \"Confirm Guess\" button." },
      { title: "See the results", description: "You'll be shown how close your guess was to the actual location. If you're within 20km, your guess is considered correct!" },
      { title: "Continue playing", description: "Each game consists of 5 rounds. Try to score as many points as possible!" },
    ],
    locationGameScoring: "Scoring: The closer your guess and the fewer hints you use, the more points you'll earn. A perfect score is 100 points per harbor.",
    triviaGameTitle: "Trivia Game",
    triviaGameDescription: "The Trivia Game tests your knowledge about Finnish harbors, maritime history, and coastal features. Here's how to play:",
    triviaGameSteps: [
      { title: "Start the game", description: "You'll be presented with a multiple-choice question about Finnish harbors." },
      { title: "Select your answer", description: "Choose the answer you believe is correct from the options provided." },
      { title: "Submit your answer", description: "Click the \"Submit Answer\" button to check if you're correct." },
      { title: "Learn from the explanation", description: "Whether right or wrong, you'll be shown an explanation that provides more information about the topic." },
      { title: "Continue playing", description: "Each game consists of 10 questions. Try to answer as many correctly as possible!" },
    ],
