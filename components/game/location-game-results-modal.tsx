// components/game/location-game-results-modal.tsx

"use client"
import { Button } from "@/components/ui/button"
import { Trophy, Target, Clock, RotateCcw, Home, Award, MapPin } from "lucide-react"
import { useLanguage } from "@/contexts/language-context"
import Link from "next/link"

interface LocationGameResultsModalProps {
  show: boolean
  score: number
  gameHistory: any[]
  gameDuration?: number
...
export default function LocationGameResultsModal({
  show,
  score,
  gameHistory,
  gameDuration,
  ...
  const averageScore = totalRounds > 0 ? Math.round(score / totalRounds) : 0
        ...
        <div className="text-center">
          ...
          <div className="space-y-2 sm:space-y-4 mb-4 sm:mb-6">
            ...
            <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 pt-1">
              Average score per harbor: {averageScore} points
            </div>
          </div>
