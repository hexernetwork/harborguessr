// profile/profile-settings-form.tsx
"use client";
...
export default function ProfileSettingsForm({ user, profile }) {
  ...
  const [preferredLanguage, setPreferredLanguage] = useState(profile?.preferred_language || user.user_metadata?.preferred_language || language || "en");
  ...
  return (
    <Card className="bg-white dark:bg-gray-800 shadow-lg rounded-lg">
      ...
      <CardContent className="space-y-6">
        ...
        {success && (
          <Alert className="mb-6 bg-green-100 dark:bg-green-900/30">
          ...
          <div className="flex flex-col items-center gap-4">
            <Avatar className="w-32 h-32 border-2 border-gray-200 dark:border-gray-700">
              {avatarUrl ? (
                ...
                <AvatarFallback className="text-4xl bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200">
                  {getInitials()}
                </AvatarFallback>
              )}
            </Avatar>
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 mt-1 w-full border-gray-300 dark:border-gray-600 rounded-md"
                required
              />
            ...
            <div className="relative">
              ...
              <Input
                ...
                value={user.email || ""}
                disabled
                className="pl-10 mt-1 w-full border-gray-300 dark:border-gray-600 rounded-md opacity-70"
              />
              <Mail className="absolute left-3 top-9 h-5 w-5 text-gray-400 dark:text-gray-500" />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Contact support to change.</p>
            </div>

            <div className="relative">
              <Label htmlFor="language" className="text-gray-700 dark:text-gray-300">Language</Label>
              <Select value={preferredLanguage} onValueChange={setPreferredLanguage}>
                <SelectTrigger className="pl-10 mt-1 w-full border-gray-300 dark:border-gray-600 rounded-md">
              ...
              <Globe className="absolute left-3 top-9 h-5 w-5 text-gray-400 dark:text-gray-500" />
            </div>
          </div>
      ...
      <CardFooter className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-4">
        <Button variant="outline" onClick={() => router.push("/profile")} className="text-gray-700 dark:text-gray-300">
          Cancel
        </Button>
